...
public class EmailTest {
    ...
    public static String myEmailAccount = "17875512076@163.com";
    public static String myEmailPassword = "zhu8605931";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "632755825@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("E:\\迪丽热巴.jpg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("E:\\nignx.txt"));  // 读取本地文件
