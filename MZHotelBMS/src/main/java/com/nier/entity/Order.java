...
public class Order implements java.io.Serializable{
	...
	public String toString() {
		return "Order [userId=" + userId + ", orderId=" + orderId + ", hotelId=" + hotelId + ", orderTime=" + orderTime
				+ ", orderMoney=" + orderMoney + ", orderIsPay=" + orderIsPay + ", isChargeback=" + isChargeback
				+ ", inDate=" + inDate + ", outDate=" + outDate + ", roomNum=" + roomNum + ", contactNum=" + contactNum
				+ ", orderEmail=" + orderEmail + ", orderDay=" + orderDay + ", peopleNum=" + peopleNum + ", hotelName="
				+ hotelName + ", hotelImg=" + hotelImg + ", hotelType=" + hotelType + ", hotelAdress=" + hotelAdress
				+ ", roomGrade=" + roomGrade + ", OrderUserName=" + OrderUserName + ", roomType=" + roomType + "]";
	}
